        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->tipo === 'gerente')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('grafico.avaliacoes')" :active="request()->routeIs('grafico.avaliacoes')">
                            {{ __('Gráficos') }}
                        </x-nav-link>
                    </div>

                @elseif (Auth::user()->tipo === 'massagista')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('massagista.agenda')" :active="request()->routeIs('massagista.agenda')">
                            {{ __('Agenda') }}
                        </x-nav-link>
                    </div>
